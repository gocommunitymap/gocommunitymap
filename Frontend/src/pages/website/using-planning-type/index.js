...
import { getUsingPlanningType, updateUsingPlanningType, deleteUsingPlanningType } from 'src/store'
import { toast } from 'react-hot-toast'
import { columns } from 'src/views/pages/website/using-planning-type/static-data'
...
import { ModalForm } from 'src/views/pages/website/using-planning-type/form'
import DeleteModal from 'src/views/components/modal/delete-modal'

const pageTitle = 'Using And Planning Types'
...
const UsingPlanningType = () => {
  ...
  const store = useSelector(state => state.usingPlanningType)
  ...
  useEffect(() => {
    dispatch(getUsingPlanningType()).then(response => {
      if (response?.error) {
  ...
  const onDelete = () => {
    setStates({ ...states, isSubmit: true })
    dispatch(deleteUsingPlanningType(deleteStates)).then(response => {
...
export default UsingPlanningType
