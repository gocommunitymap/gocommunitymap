...
import { getReceptions, updateReceptions, deleteReceptions } from 'src/store'
import { toast } from 'react-hot-toast'
import { columns } from 'src/views/pages/website/receptions/static-data'
...
import { ModalForm } from 'src/views/pages/website/receptions/form'
import DeleteModal from 'src/views/components/modal/delete-modal'

const pageTitle = 'Receptions'
...
const Receptions = () => {
  ...
  const store = useSelector(state => state.receptions)
  ...
  useEffect(() => {
    dispatch(getReceptions()).then(response => {
      if (response?.error) {
  ...
  const onDelete = () => {
    setStates({ ...states, isSubmit: true })
    dispatch(deleteReceptions(deleteStates)).then(response => {
