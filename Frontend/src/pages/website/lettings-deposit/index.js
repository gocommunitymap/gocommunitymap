...
import { getLettingsDeposit, updateLettingsDeposit, deleteLettingsDeposit } from 'src/store'
import { toast } from 'react-hot-toast'
import { columns } from 'src/views/pages/website/lettings-deposit/static-data'
...
import { ModalForm } from 'src/views/pages/website/lettings-deposit/form'
import DeleteModal from 'src/views/components/modal/delete-modal'

const pageTitle = 'Lettings Deposit Setup'
...
const LettingsDeposit = () => {
  ...
  const store = useSelector(state => state.lettingsDeposit)
  ...
  useEffect(() => {
    dispatch(getLettingsDeposit()).then(response => {
      if (response?.error) {
  ...
  const onDelete = () => {
    setStates({ ...states, isSubmit: true })
    dispatch(deleteLettingsDeposit(deleteStates)).then(response => {
...
export default LettingsDeposit
