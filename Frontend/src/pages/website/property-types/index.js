...
import { getPropertyTypes, updatePropertyTypes, deletePropertyTypes } from 'src/store'
import { toast } from 'react-hot-toast'
import { columns } from 'src/views/pages/website/property-types/static-data'
...
import { ModalForm } from 'src/views/pages/website/property-types/form'
import DeleteModal from 'src/views/components/modal/delete-modal'

const pageTitle = 'Property Types'
...
const PropertyTypes = () => {
  ...
  const store = useSelector(state => state.propertyTypes)
  ...
  useEffect(() => {
    dispatch(getPropertyTypes()).then(response => {
      if (response?.error) {
  ...
  const onDelete = () => {
    setStates({ ...states, isSubmit: true })
    dispatch(deletePropertyTypes(deleteStates)).then(response => {
