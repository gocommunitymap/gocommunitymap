...
import { getBedrooms, updateBedrooms, deleteBedrooms } from 'src/store'
import { toast } from 'react-hot-toast'
import { columns } from 'src/views/pages/website/bedrooms/static-data'
...
import { ModalForm } from 'src/views/pages/website/bedrooms/form'
import DeleteModal from 'src/views/components/modal/delete-modal'

const pageTitle = 'Bedroom Setup'
...
const Bedrooms = () => {
  ...
  const store = useSelector(state => state.bedrooms)
  ...
  useEffect(() => {
    dispatch(getBedrooms()).then(response => {
      if (response?.error) {
  ...
  const onDelete = () => {
    setStates({ ...states, isSubmit: true })
    dispatch(deleteBedrooms(deleteStates)).then(response => {
