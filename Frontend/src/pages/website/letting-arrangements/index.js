...
import { getLettingArrangements, updateLettingArrangements, deleteLettingArrangements } from 'src/store'
import { toast } from 'react-hot-toast'
import { columns } from 'src/views/pages/website/letting-arrangements/static-data'
...
import { ModalForm } from 'src/views/pages/website/letting-arrangements/form'
import DeleteModal from 'src/views/components/modal/delete-modal'

const pageTitle = 'Letting Arrangements Setup'
...
const LettingArrangements = () => {
  ...
  const store = useSelector(state => state.lettingArrangements)
  ...
  useEffect(() => {
    dispatch(getLettingArrangements()).then(response => {
      if (response?.error) {
  ...
  const onDelete = () => {
    setStates({ ...states, isSubmit: true })
    dispatch(deleteLettingArrangements(deleteStates)).then(response => {
...
export default LettingArrangements
