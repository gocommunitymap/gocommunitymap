...
import { getFurnished, updateFurnished, deleteFurnished } from 'src/store'
import { toast } from 'react-hot-toast'
import { columns } from 'src/views/pages/website/furnished/static-data'
...
import { ModalForm } from 'src/views/pages/website/furnished/form'
import DeleteModal from 'src/views/components/modal/delete-modal'

const pageTitle = 'Furnished Setup'
...
const Furnished = () => {
  ...
  const store = useSelector(state => state.furnished)
  ...
  useEffect(() => {
    dispatch(getFurnished()).then(response => {
      if (response?.error) {
  ...
  const onDelete = () => {
    setStates({ ...states, isSubmit: true })
    dispatch(deleteFurnished(deleteStates)).then(response => {
