...
import { getBathrooms, updateBathrooms, deleteBathrooms } from 'src/store'
import { toast } from 'react-hot-toast'
import { columns } from 'src/views/pages/website/bathrooms/static-data'
...
import { ModalForm } from 'src/views/pages/website/bathrooms/form'
import DeleteModal from 'src/views/components/modal/delete-modal'

const pageTitle = 'Bathroom Setup'
...
const Bathrooms = () => {
  ...
  const store = useSelector(state => state.bathrooms)
  ...
  useEffect(() => {
    dispatch(getBathrooms()).then(response => {
      if (response?.error) {
  ...
  const onDelete = () => {
    setStates({ ...states, isSubmit: true })
    dispatch(deleteBathrooms(deleteStates)).then(response => {
