...
export const SearchRentalSectionComCard = () => {
  // ** Hook
  ...
  const onSubmit = data => {
    ...
    replace(`/com-rental/properties${_params}`)
  }
                ...
                <Card sx={{ p: 5 }}>
                  <Grid container spacing={3}>
                    <Grid item xs={12} textAlign='left'>
                      ...
                      <Typography variant='subtitle2'>Search Commercial rental in the UK.</Typography>
                    </Grid>
                    <Grid item xs={12} textAlign='left'>
