...
export const PropertyDetailCardCom = ({ data }) => {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <Grid container spacing={2} p={3}>
            ...
            <Grid item xs={12}>
              <Typography variant='subtitle1'>{cardData.PLACE}</Typography>
              <Typography variant='subtitle2'>
                {cardData.PROPERTY_TYPE_DESC} {cardData.LISTING_TYPE_DESC}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} display='flex' px={2}>
              <Chip variant='filled' color='secondary' label='Commercial' />
            </Grid>
            <Grid item xs={12} display='flex' px={2}>
