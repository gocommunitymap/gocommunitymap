...
export const columns = [
  ...
  { flex: 1, minWidth: 70, headerName: 'ID', field: 'SECTION_ID' },
  { flex: 1, minWidth: 200, headerName: 'TITLE', field: 'SECTION_TITLE' },

  { flex: 1, minWidth: 200, headerName: 'HEADING', field: 'HEADING' },
  { flex: 1, minWidth: 400, headerName: 'DESCRIPTION', field: 'DESCRIPTION' },
  { flex: 1, minWidth: 200, headerName: 'MORE BUTTON TEXT', field: 'MORE_BUTTON_TEXT' },
  { flex: 1, minWidth: 200, headerName: 'MORE BUTTON LINK', field: 'MORE_BUTTON_LINK' },
  { flex: 1, minWidth: 80, headerName: 'SORT ORDER', field: 'SORT_ORDER' },
  {
    flex: 1,
    minWidth: 120,
    align: 'center',
