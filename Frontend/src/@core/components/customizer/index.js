        ...
        <PerfectScrollbar options={{ wheelPropagation: false }}>
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                <FormControlLabel value='default' label='Default' control={<Radio color='secondary' />} />
                <FormControlLabel value='bordered' label='Bordered' control={<Radio color='secondary' />} />
              </RadioGroup>
            </Box>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                ...
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
                <FormControlLabel value='light' label='Light' control={<Radio color='secondary' />} />
                <FormControlLabel value='dark' label='Dark' control={<Radio color='secondary' />} />
                {layout === 'horizontal' ? null : (
                  <FormControlLabel value='semi-dark' label='Semi Dark' control={<Radio color='secondary' />} />
                )}
              </RadioGroup>
            </Box>
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                ...
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
                <FormControlLabel value='full' label='Full' control={<Radio color='secondary' />} />
                <FormControlLabel value='boxed' label='Boxed' control={<Radio color='secondary' />} />
              </RadioGroup>
            </Box>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                ...
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
                <FormControlLabel value='fixed' label='Fixed' control={<Radio color='secondary' />} />
                <FormControlLabel value='static' label='Static' control={<Radio color='secondary' />} />
                {layout === 'horizontal' ? null : (
                  <FormControlLabel value='hidden' label='Hidden' control={<Radio color='secondary' />} />
                )}
              </RadioGroup>
            </Box>
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: layout === 'horizontal' && appBar === 'hidden' ? {} : 4 }}>
              ...
              <RadioGroup
                ...
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
                <FormControlLabel value='vertical' label='Vertical' control={<Radio color='secondary' />} />
                <FormControlLabel value='horizontal' label='Horizontal' control={<Radio color='secondary' />} />
              </RadioGroup>
            </Box>
            ...
            {navHidden || layout === 'horizontal' ? null : (
              <Box sx={{ mb: 4 }}>
                ...
                <RadioGroup
                  ...
                  sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
                >
                  <FormControlLabel value='accordion' label='Accordion' control={<Radio color='secondary' />} />
                  <FormControlLabel value='collapse' label='Collapse' control={<Radio color='secondary' />} />
                </RadioGroup>
              </Box>
            )}
