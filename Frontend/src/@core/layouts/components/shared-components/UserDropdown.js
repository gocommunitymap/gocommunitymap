...
const UserDropdown = props => {
  ...
  return (
    <Fragment>
      <Button color='primary' onClick={handleDropdownOpen}>
        <Typography
          color='primary.main'
          fontWeight='bold'
        ...
        <Icon icon='tabler:user-circle' fontSize={30} />
        <Icon icon='tabler:chevron-down' fontSize={15} />
      </Button>
      ...
      >
        ...
        <MenuItem sx={{ p: 0 }} onClick={() => handleDropdownClose('/saved')}>
          <Box sx={styles}>
