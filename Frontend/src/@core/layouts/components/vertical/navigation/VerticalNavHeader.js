  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          {!navCollapsed && <CompanyLogo width={60} />}
          <HeaderTitle
            variant='h6'
            sx={{
              ...menuCollapsedStyles,
              ...(navCollapsed && !navHover ? {} : { fontSize: '14px !important', ml: 2 })
            }}
          >
            {themeConfig.portalName}
          </HeaderTitle>
        </LinkStyled>
      )}
      ...
      {hidden ? (
        ...
        <IconButton
          ...
          sx={{ p: 0, color: 'common.white', backgroundColor: 'transparent !important' }}
        >
