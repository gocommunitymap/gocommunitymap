                ...
                ;(l.hasClass(o, c)
                  ...
                  : function () {
                      ...
                      l.hasClass(n, m)
                        ...
                        : l.hasClass(n, f)
                        ? l.css(o, { left: e.width + 'px', top: e.top - t.top + 'px' })
                        : l.hasClass(n, p)
                        ? l.css(o, { right: e.width + 'px', top: e.top - t.top + 'px' })
                        : l.css(o, { top: e.top - t.top + e.height + 'px' }),
                        l.hasClass(o, h) && l.css(o, { top: 'auto', bottom: e.top - t.top + 'px' }),
                        l.addClass(o, c),
                        setTimeout(function () {
      ...
      function (t, e, i) {
        ...
        e.exports = {
          getMenuPositionalCSS: function (t, e, i) {
            ...
            return (
              a < u && ((f = n + d + i * m), (p = l * m + 2 * d - c), (h = Math.min(f, p))),
      ...
      function (t, e, i) {
        ...
        function a(e, t, i, n) {
          ...
          t.split(' ').map(function (t) {
            for (s = (o = a[t] || []).length; s--; )
              (r = o[s]),
                (void 0 === i || (r[0] === i && r[1] === n)) && (o.splice(s, 1), e.removeEventListener(t, r[0], r[1]))
          })
        }
        function r(t, e) {
          var i = window
        ...
        e.exports = {
          ...
          offset: function (t) {
            ...
            return { top: i.top + n, left: i.left + o, height: i.height, width: i.width }
          },
          on: s,
            ...
            var i = !1,
              ...
              u = function (t) {
                ;('readystatechange' == t.type && 'complete' != n.readyState) ||
                  (('load' == t.type ? o : n)[a](l + t.type, u, !1), !i && (i = !0) && e.call(o, t.type || t))
              },
              c = function () {
                try {
                  r.doScroll('left')
              ...
              ;(t = ['overflow:hidden']),
                a &&
                  (r.scrollHeight > r.clientHeight &&
                    ((i = parseInt(m.css(s, 'padding-right')) + a), t.push('padding-right:' + i + 'px')),
                  r.scrollWidth > r.clientWidth &&
                    ((i = parseInt(m.css(s, 'padding-bottom')) + a), t.push('padding-bottom:' + i + 'px'))),
                (e = '.' + p + '{'),
        ...
        e.exports = function (t) {
          ...
          if ('on' === t) {
            for (var i, n, o, r = arguments.length - 1; 0 < r; r--)
              (i = arguments[r]), 'object' === l.type(i) && (n = i), i instanceof Element && 1 === i.nodeType && (o = i)
        ...
        function a(t) {
          if ('mousedown' !== t.type || 0 === t.button) {
            ...
            if (!e.disabled) {
              ...
              ;(r = 2 * (o = Math.sqrt(s.height * s.height + s.width * s.width)) + 'px'),
                l.css(i, {
                  width: r,
                  height: r,
            ...
            if (!y.hasClass(e, 'mui-select--use-default')) {
              ...
              ;(i.className = 'mui-event-trigger'),
                ...
                y.on(i, n.animationEvents, function (t) {
                  ...
                  t.stopPropagation(),
                    'mui-node-disabled' === t.animationName ? e.removeAttribute('tabIndex') : (e.tabIndex = 0)
                })
            }
          }
        }
        ...
        ;(p.prototype._createMenuEl = function (t, e) {
          ...
          (p.prototype.selectPos = function (t) {
            ...
            n.top < 0
              ...
              : n.top > window.innerHeight && (i.scrollTop = i.scrollTop + (n.top + n.height - window.innerHeight) + 5)
          }),
        ...
        function s(t) {
          ...
          f.hasClass(c, v) ||
            ...
            (i = (function (t) {
              ...
              ((n = i.id), (u = '[' + h + '="' + n + '"]'), (o = document.querySelectorAll(u)[0]), (e = o.parentNode)),
      ...
      function (t, e, i) {
          ...
          !0 !== e._muiTextfield &&
            ...
            n.on(e, 'blur', function t() {
              document.activeElement !== e &&
                (n.removeClass(e, s), n.addClass(e, 'mui--is-touched'), n.off(e, 'blur', t))
            }),
        ...
        e.exports = {
          ...
          initListeners: function () {
            for (
              var t = document,
                e = t.querySelectorAll('.mui-textfield > input, .mui-textfield > textarea'),
                i = e.length;
              i--;
            ...
            r.onAnimationStart('mui-textfield-inserted', function (t) {
              ...
              setTimeout(function () {
                var t =
                  ...
                  ['-webkit-transition', '-moz-transition', '-o-transition', 'transition', ''].join(
                    ':all .15s ease-out;'
                  ) +
                  '}'
                o.loadStyle(t)
