...
namespace BusinessLogicLayer.Repositories
{
    public class SectionRepository: ISectionRepository
    {
        ...
        public SectionRepository(IDataAccess db, IConfiguration configuration)
        {
            _db = db;
        ...
        public object GetSections(Sections SectionData)
        {
            try
            {
                ...
                dyParam.AddDynamicParams("USER", DbType.Int32, ParameterDirection.Input, SectionData.USER);
