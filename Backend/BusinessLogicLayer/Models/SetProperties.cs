...
{
    public class SetProperties : MandatoryParams
    {
        ...
        public List<SetNearByPlace>? NEARBY_PLACES { get; set; }
        public List<PropertyRules>? PROPERTY_RULES { get; set; }
        public List<FAQs>? PROPERTY_FAQS { get; set; }
        public string[]? POPULAR_REGIONS { get; set; }
